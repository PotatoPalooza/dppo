                ...
                if eval_mode:
                    ...
                    if self.use_wandb:
                        wandb.log(
                            {
                                "iteration": self.itr,
                                "env_step": cnt_train_step,
                                "eval/success_rate": success_rate,
                                "eval/episode_reward_mean": avg_episode_reward,
                                "eval/best_reward_mean": avg_best_reward,
                                "eval/num_episode": num_episode_finished,
                                "charts/eval_success_rate": success_rate,
                                "charts/eval_episode_reward_mean": avg_episode_reward,
                        ...
                        wandb.log(
                            {
                                "iteration": self.itr,
                                "env_step": cnt_train_step,
                                "train/loss": iteration_stats["loss"],
                                "train/pg_loss": iteration_stats["pg_loss"],
                                "train/value_loss": iteration_stats["value_loss"],
                                "train/bc_loss": iteration_stats["bc_loss"],
                                "train/entropy_loss": iteration_stats["entropy_loss"],
                                "train/eta": iteration_stats["eta"],
                                "train/approx_kl_mean": iteration_stats["approx_kl_mean"],
                                "train/approx_kl_max": iteration_stats["approx_kl_max"],
                                "train/ratio_mean": iteration_stats["ratio_mean"],
                                "train/ratio_last": iteration_stats["ratio_last"],
                                "train/clipfrac_mean": iteration_stats["clipfrac_mean"],
                                "train/explained_variance": iteration_stats["explained_variance"],
                                "train/episode_reward_mean": avg_episode_reward,
                                "train/num_episode": num_episode_finished,
                                "train/success_rate": success_rate,
                                "train/diffusion_min_sampling_std": diffusion_min_sampling_std,
                                "train/actor_lr": self.actor_optimizer.param_groups[0]["lr"],
                                "train/critic_lr": self.critic_optimizer.param_groups[0]["lr"],
                                "charts/train_success_rate": success_rate,
                                "charts/train_episode_reward_mean": avg_episode_reward,
                                "charts/loss": iteration_stats["loss"],
